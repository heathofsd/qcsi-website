...
export const headliners: Artist[] = [
  {
    ...
    fullBio: "In two decades on the road, Jeffrey Foucault has become one of the most distinctive voices in American music, refining a sound instantly recognizable for its simplicity and emotional power. Across a string of critically acclaimed studio albums — \"stark, literate songs that are as wide open as the landscape of his native Midwest\" (The New Yorker), \"beat-up troubadour folk whittled to dolorous perfection\" (Uncut) — he has built a brick-and-mortar international touring career and a devoted following, one that includes luminaries like Van Dyke Parks, Greil Marcus, and Don Henley. The Universal Fire (Fluff & Gravy, 2024), his first album of entirely new material since 2018, was cut live in one room with his all-star band augmented by members of Calexico and Bon Iver: both a working wake for his late friend and drummer Billy Conway and a meditation on the nature of beauty, artifact, and loss.",
