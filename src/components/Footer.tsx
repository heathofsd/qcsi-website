    ...
    <footer className="bg-charcoal text-cream">
      <div className="mx-auto max-w-7xl px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 gap-12 md:grid-cols-4">
          ...
          {/* Navigation */}
          <div>
            <h4 className="text-xs font-bold uppercase tracking-widest text-amber mb-4">
              Explore
            </h4>
        ...
        <div className="mt-12 pt-8 border-t border-cream/10 flex flex-col sm:flex-row justify-between items-center gap-4">
          <p className="text-xs text-cream/40">
            &copy; {new Date().getFullYear()} Queen City Songwriters Inc. A
            501(c)(3) nonprofit organization. EIN: 99-3218012
          </p>
          <p className="text-xs text-cream/40">
